...
public interface EstacionTrabajoRepository extends CrudRepository<EstacionTrabajo, Integer> {
    //Uso de DTO basado en interfaces o proyecciones -> Proyeccion cerrada
    public Optional<EstacionTrabajoVista> findByCodigo(String codigo);

    @Query(value = "select tb_estaciontrabajo_id, tb_estaciontrabajo_cod, tb_estaciontrabajo_nom, tb_sucursal_nom" +
            " from sh_empresa_20441636831.fn_select_estaciontrabajo()", nativeQuery = true)
