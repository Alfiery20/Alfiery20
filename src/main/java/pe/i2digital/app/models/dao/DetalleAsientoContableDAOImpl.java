...
import pe.i2digital.app.models.dto.mapper.SeguimientoDocumentoMapper;
...
public class DetalleAsientoContableDAOImpl implements DetalleAsientoContableDAO{
    ...
    public List<DetalleAsientoContable> seguimientoDocumentos(String esquema, String periodo, Integer idDocumento) {
        return jdbcTemplate.query("select * from " + esquema + ".fn_at_select_seguimiento_documentos(?,?)",
                new SeguimientoDocumentoMapper(), new Object[] {periodo,idDocumento});
    }
    ...
    public List<DetalleAsientoContable> seguimientoDocumentos2(String esquema, String periodo, Integer idDocumento) {
        ...
        return namedParameterJdbcTemplate.query("select * from " + esquema + ".fn_at_select_seguimiento_documentos(:periodo,:idDocumento)",
                parameters, new RowMapper<DetalleAsientoContable>() {
                    @Override
